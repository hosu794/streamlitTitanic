...
def main():
    ...
    data = pd.DataFrame([[pclass_radio, age_slider, fare_slider, sibsp_slider, parch_slider, sex_radio, embarked_radio]],
                        columns=['pclass', 'age', 'fare', 'sibsp', 'parch', 'sex', 'embarked'])
